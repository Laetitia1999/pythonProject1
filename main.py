...
# sent reminder email
view.mail(config['mail']['smtp_server'], config['mail']['sender_email'], config['mail']['sender_password'],
          config['mail']['recipient_email'], config['mail']['mail_subject'], config['mail']['mail_body'],
          final_list)
